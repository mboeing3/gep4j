Here is a simple decision tree example with nominal attributes from section 9.1 if the Gene Expression Programming book.

After a few generations if should print out something like this:

```
Generation 13, error = 0.0000000000000000, 
if (Outlook == sunny) { 
    if (Humidity == high) { 
        No
