...
public class NominalTerminalFactory implements INodeFactory {
	private Object[] terms;
	
	public NominalTerminalFactory(Object[] t) {
		terms = t;
	}

	@Override
	public INode create(Random rng) {
		int index = rng.nextInt(terms.length);
		return new NomialTerminal(terms[index]);
	}
